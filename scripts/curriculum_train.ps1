...
$model = "gemma"
$enc_dim = 768
python .\dense_fusion_train.py --debug --model $model --data_path "../${model}_multimodal_bins" --test_path "../${model}_multimodal_bins_rw" --enc_dim $enc_dim --clinical --path_lang --rad_lang --label_col $target --loss_fn $loss
